...
<div id="task" class="task-panel">
	...
	<div id="dashboards" class="task-wrapper task-open">
...
<div id="wrapper" class="toggled-2 task-menu">       
	<div id="sidebar-wrapper">
    	<ul class="sidebar-nav nav-pills nav-stacked task-evolution" id="menu">
			<li class="active">
	        	<a href="#" id="dashboards"><span class="fa-stack fa-lg pull-left"><i class="fa fa-dashboard fa-stack-1x "></i></span> <?= Yii::t('task', 'Dashboard') ?></a></li>
	        <li>
